...
#listmode_data = stir.ListModeData.read_from_file("Sim_1.Coincidences.hroot")
listmode_data = stir.ListModeData.read_from_file("Sim_1_test.Coincidences.hroot")
...
template_projdata = stir.ProjData.read_from_file("STIRScanner_test.hs")
